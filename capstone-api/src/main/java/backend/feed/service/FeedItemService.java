...
public class FeedItemService {
	...
	public FeedCreateResponse createOfferFeed(CreateOfferFeedRequest request, String authorId, String authorNickname) {
		...
		chatService.ensureGroupRoomForPost(saved.getId(), saved.getTitle(), Set.of(authorId));
	...
	public FeedApplicationResponse acceptApplication(String feedId, String applicationId, String requesterId) {
		...
		chatService.ensureGroupRoomForPost(feedId, feedItem.getTitle(), Set.of(application.getUserId()));
		...
		if (feedItem.isFundingGoalMet()) {
			...
			chatService.linkGroupRoomToSpot(feedId, spot.getId(), spot.getTitle(), participantIds);
			try {
